    ...
    <?php
      ...
      if($status=="pass"){
        ...
        <div class="alert alert-success alert-dismissible" role="alert">
          ...
          <hr />
          <p>
          The product that you was added is <p style="color:green;">successfully</p> <p> what do you want to do next... </p> <br />
            <br /><br />
            <a href="dashboard.php" class="btn btn-success">Add Another Record</a>
        ...
        <div class="alert alert-danger alert-dismissible" role="alert">
          ...
          <hr />
          <p>
            The product that you was added is <p style="color:red;">Not Successfully added</p> <p> what do you want to do next... </p><br />
            <br /><br />
